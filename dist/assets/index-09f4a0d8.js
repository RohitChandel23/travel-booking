import{a6 as x,l as O,t as W,m as I,x as y}from"./index-7d485662.js";import{n as v,c as M}from"./if-defined-265b4cad.js";import"./index-10422778.js";import{b as N}from"./browser-e933942f.js";const A=.1,k=2.5,w=7;function E(l,r,h){return l===r?!1:(l-r<0?r-l:l-r)<=h+A}function T(l,r){const h=Array.prototype.slice.call(N.create(l,{errorCorrectionLevel:r}).modules.data,0),u=Math.sqrt(h.length);return h.reduce((p,d,f)=>(f%u===0?p.push([d]):p[p.length-1].push(d))&&p,[])}const D={generate({uri:l,size:r,logoSize:h,dotColor:u="#141414"}){const p="transparent",f=[],c=T(l,"Q"),a=r/c.length,z=[{x:0,y:0},{x:1,y:0},{x:0,y:1}];z.forEach(({x:o,y:t})=>{const s=(c.length-w)*a*o,e=(c.length-w)*a*t,n=.45;for(let i=0;i<z.length;i+=1){const m=a*(w-i*2);f.push(x`
            <rect
              fill=${i===2?u:p}
              width=${i===0?m-5:m}
              rx= ${i===0?(m-5)*n:m*n}
