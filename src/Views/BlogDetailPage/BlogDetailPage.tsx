...
function BlogDetailPage() {
  ...
  // Base URL for sharing (replace with your domain or use dynamic)
  const shareUrl = `https://yourdomain.com/blog/${id}`; // Adjust to your domain
  // const shareUrl = `${window.location.origin}/blog/${id}`; // Alternative for dynamic URL
