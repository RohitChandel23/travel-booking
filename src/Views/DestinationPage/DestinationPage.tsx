...
<div className="destination-grid-wrapper">
        ...
        <div className="grouped-destinations-grid">
                ...
                destinationData.firstGrouped.map((countryName)=> 
                        <DestinationCard countryName={countryName} countryImage={ProjectImages.TOURPAGE_BANNER} />
                )}
                </div>
        ...
        <DestinationCard countryName={destinationData.singleDestination} countryImage={ProjectImages.TOURPAGE_BANNER}/>  {  /* country-name, country-image*/  }
        </div>
        </div>
